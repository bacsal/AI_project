...
for index, row in df.iterrows():
    ...
    enemy_champion = row['enemychampName']   #적 챔피언 이름
    win = row['win']                    #이겼는지?
...
# 결과 데이터프레임을 csv로 저장
result_file_path = os.path.join(script_dir, 'Lable.csv')
